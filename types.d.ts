...
declare module 'https://cdn.jsdelivr.net/npm/ol@9.0.0/+esm' {
  export * from 'ol'
}

declare module 'https://cdn.jsdelivr.net/npm/ol@9.0.0/source.js/+esm' {
  export * from 'ol/source.js'
}

declare module 'https://cdn.jsdelivr.net/npm/ol@9.0.0/layer.js/+esm' {
  export * from 'ol/layer.js'
}
